...
void SecureChannelInitTest(nlTestSuite * inSuite, void * inContext)
{
    ...
    P256Keypair keypair(SupportedECPKeyUsage::ECDH, SupportedECPKeyLifetime::EPHEMERAL_INTERNAL);
    NL_TEST_ASSERT(inSuite, keypair.Initialize() == CHIP_NO_ERROR);

    P256Keypair keypair2(SupportedECPKeyUsage::ECDH, SupportedECPKeyLifetime::EPHEMERAL_INTERNAL);
